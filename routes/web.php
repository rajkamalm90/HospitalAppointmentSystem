...
Route::post('/appointment', [AppointmentController::class, 'submitForm']);
...
// Show the form
Route::get('/contact', [ContactUsController::class, 'form'])->name('form');
// Submit form data
Route::post('/contact/submit', [ContactUsController::class, 'data_submit'])->name('submit');
// Fetch all data
Route::get('/getall', [ContactUsController::class, 'data_fetch'])->name('getall');
// Edit data
Route::get('/edit/{id}', [ContactUsController::class, 'data_edit'])->name('edit');
// Update data
Route::post('/update', [ContactUsController::class, 'data_update'])->name('update');
// Delete data
Route::get('/delete/{id}', [ContactUsController::class, 'data_delete'])->name('delete');
