                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li onclick="check_active('About')"><a id="About" data-scroll
                                    ...
                                    <li onclick="check_active('appointment')">
                                        <a id="appointment" data-scroll href="{{ url('/appointment') }}">Appointment</a>
                                    </li>

                                    <li onclick="check_active('appointment')">
                                        <a id="appointment" data-scroll href="{{ url('contact') }}">contact</a>
                                    </li>

                                    <li onclick="check_active('getall')">
                                        <a id="appointment" data-scroll href="{{ url('getall') }}">userinfo</a>
                                    </li>
